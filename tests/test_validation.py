...
def fill_time_profile_dict_all(dict, self):
    ...
    dict['Median Ratio'].append('0.5484416576121018')
    dict["Mean Error (ME)"].append('0.26338502445434836')
    dict["Median Error (MedE)"].append('-0.8233480008684413')
    dict["Mean Log Error (MLE)"].append('-0.1884057971014493')
    dict["Median Log Error (MedLE)"].append('-0.2608695652173913')
    dict["Mean Absolute Error (MAE)"].append('4.1868830206983585')
    dict["Median Absolute Error (MedAE)"].append('5.061898993497573')
    dict["Mean Absolute Log Error (MALE)"].append('0.5072463768115942')
    dict["Median Absolute Log Error (MedALE)"].append('0.4782608695652174')
