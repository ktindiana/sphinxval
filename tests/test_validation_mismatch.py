...
class Test_AllFields_Mismatch(unittest.TestCase):
    ...
    def test_all(self):
        ...
        utils.utility_delete_output()  # Comment out when you want to bug fix since you may want to have the sphinx dataframe to look at
