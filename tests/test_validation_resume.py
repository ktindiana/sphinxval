...
def mock_df_populate(dict):
    ...
    dict['Observed SEP Event'].append(datetime(year = 2022, month = 4, day = 2,  hour = 14, minute = 40))
    ...
    dict["Last Data Time to Issue Time"].append(250.06666666666666)
            #OBSERVATIONS
    dict["Prediction Number of CMEs"].append("1")
    dict["Prediction CME Start Time"].append(datetime(year = 2022, month = 4, day = 2, hour = 13, minute =38)) #Timestamp of 1st coronagraph image CME is visible in
    dict["Prediction CME Liftoff Time"].append(""), #Timestamp of coronagraph image with 1st indication of CME liftoff (used by CACTUS)
    dict["Prediction CME Latitude"].append(-15.0)
    dict["Prediction CME Longitude"].append(54.0)
    dict["Prediction CME Speed"].append(1370.0)
    dict["Prediction CME Half Width"].append(45.0)
    dict["Prediction CME PA"].append("")
    dict["Prediction CME Catalog"].append("2022-04-02T13:38:00-CME-001")
    dict['Prediction CME Catalog ID'].append("")
    dict["Observed SEP CME Start Time"].append(datetime(year = 2022, month = 4, day = 2, hour = 13, minute =38)) #Timestamp of 1st coronagraph image CME is visible in
    dict["Observed SEP CME Liftoff Time"].append(""), #Timestamp of coronagraph image with 1st indication of CME liftoff (used by CACTUS)
    dict["Observed SEP CME Latitude"].append(-15.0)
    dict["Observed SEP CME Longitude"].append(54.0)
    dict["Observed SEP CME Speed"].append(1370.0)
    dict["Observed SEP CME Half Width"].append(45.0)
    dict["Observed SEP CME PA"].append("")
    dict["Observed SEP CME Catalog"].append("2022-04-02T13:38:00-CME-001")
    dict['Observed SEP CME Catalog ID'].append("")
    dict["Prediction Number of Flares"].append("0")
    dict["Prediction Flare Latitude"].append("")
    dict["Prediction Flare Longitude"].append("")
    dict["Prediction Flare Start Time"].append("")
    dict["Prediction Flare Peak Time"].append("")
    dict["Prediction Flare End Time"].append("")
    dict["Prediction Flare Last Data Time"].append("")
    dict["Prediction Flare Intensity"].append("")
    dict["Prediction Flare Integrated Intensity"].append("")
    dict["Prediction Flare NOAA AR"].append("")
    dict["Observed SEP Flare Latitude"].append("")
    dict["Observed SEP Flare Longitude"].append("")
    dict["Observed SEP Flare Start Time"].append("")
    dict["Observed SEP Flare Peak Time"].append("")
    dict["Observed SEP Flare End Time"].append("")
    dict["Observed SEP Flare Intensity"].append("")
    dict["Observed SEP Flare Integrated Intensity"].append("")
    dict["Observed SEP Flare NOAA AR"].append("")
    ...
    dict["Overlapping Observations"].append(str([]))
    ...
    dict['Farside'].append("")
    dict['Is Source Flare'].append("")
    dict['All Observation Flare Peak Times'].append(str([]))
    dict['All Prediction Flares'].append("")
    dict['Is Source CME'].append("")
    dict["All Observation CME Start Times"].append("")
    dict['All Prediction CMEs'].append("")
