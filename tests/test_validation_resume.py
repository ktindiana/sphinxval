...
class Test_Resume(unittest.TestCase):
    ...
    def step_1(self):
        ...
        for jsons in observation_json:
            observation = utils_test.utility_load_observation(jsons, self.obs_energy_channel)
        ...
        for jsons in forecast_json:
            forecast = utils_test.utility_load_forecast(jsons, config_tests.mm_pred_energy_channel)
