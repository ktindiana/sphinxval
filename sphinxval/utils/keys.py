...
#JSON files
#2021-08-17, changes in 0.2: Updating key locations to match updated
#   CCMC json format for fluence spectra and new max intensity field
#   peak_intensity_max.
#2021-08-18, changes in 0.3: updating version to match the same code kept
#   in the operational-sep github and for the operational_sep_quantities.py
#   project. Will keep these versions matched. CCMC added new entries in the
#   json for fluence spectra and maximum flux and these have been added here.
#2022-02-08, changes in 0.4: added id_validated array
#2022-02-23, changes in 0.5: added id_peak_intensity_max and all related
#   fields to the arrays id_all, id_validated, id_all_units

def about_keys():
    """ About keys.py
    
        This version of keys.py is maintained in the validation project.
        ...
        This program coupled with validation_json_handler.py will access
...
###UNDER 'triggers'
#Only make the particle intensity ongoing event fields work for now
#K. Whitman 2023-04-06

#CME
id_cme_start_time = "cme-start-time"
id_cme_liftoff_time = "cme-liftoff-time"
id_cme_lat = "cme-lat"
id_cme_lon = "cme-lon"
id_cme_pa = "cme-pa"
id_cme_half_width = "cme-half-width"
id_cme_speed = "cme-speed"
id_cme_acceleration = "cme-acceleration"
id_cme_height = "cme-height"
id_cme_time_at_height_time = "cme-time-at-height-time"
id_cme_time_at_height_height = "cme-time-at-height-height"
id_cme_coordinates = "cme-coordinates"
id_cme_catalog = "cme-catalog"
id_cme_catalog_id = "cme-catalog-id"
id_cme_urls = "cme-urls"

#FLARES
id_flare_last_data_time = "flare-last-data-time"
id_flare_start_time = "flare-start-time"
id_flare_peak_time = "flare-peak-time"
id_flare_end_time = "flare-end-time"
id_flare_location = "flare-location"
id_flare_intensity = "flare-intensity"
id_flare_integrated_intensity = "flare-integrated-intensity"
id_flare_noaa_region = "flare-noaa-region"
id_flare_urls = "flare-urls"

#CME Simulation
id_cme_sim_model = "cme-sim-model"
id_cme_sim_completion_time = "cme-sim-completion-time"
id_cme_sim_urls = "cme-sim-urls"

#Particle Intensity
id_pi_observatory = "pi-observatory"
id_pi_instrument = "pi-instrument"
id_pi_last_data_time = "pi-last-data-time"
id_pi_ongoing_events = "pi-ongoing-events"
id_pi_ongoing_events_start_time = "pi-ongoing-events-start-time"
id_pi_ongoing_events_threshold ="pi-ongoing-events-threshold"
id_pi_ongoing_events_energy_min = "pi-ongoing-events-energy-min"
id_pi_ongoing_events_energy_max = "pi-ongoing-events-energy-max"
...
id_all = [id_short_name,id_spase_id,id_issue_time,id_options,
            ...
            id_peak_intensity_esp_time,id_peak_intensity_max,
            id_peak_intensity_max_units,id_peak_intensity_max_uncertainty,
...
id_validated = [id_peak_intensity,id_peak_intensity_time,
            id_peak_intensity_esp,id_peak_intensity_esp_time,
            id_peak_intensity_max,id_peak_intensity_max_time,
            id_fluence,id_fluence_spectrum,
            id_event_length_start_time,id_event_length_end_time,
            id_thresh_crossing_time,id_probability,
            id_all_clear,id_all_clear_threshold,
            id_all_clear_threshold_units,id_sep_profile]
...
id_all_units = [id_energy_units, id_peak_intensity_units,
            id_peak_intensity_esp_units, id_peak_intensity_max_units,
            id_fluence_units,id_fluence_spectrum_threshold_units,
            id_fluence_spectrum_fluence_units,
            id_event_length_threshold_units, id_crossing_threshold_units,
            id_prob_threshold_units, id_all_clear_threshold_units]
...
def get_key_chain(value, index=0):
    ...
    ###########################################################################
    ####WITHIN BOTH 'triggers' DICTIONARY
    if value == id_pi_ongoing_events:
        key_chain = ['triggers','particle_intensity','ongoing_events'] #array of dict
    if value == id_pi_ongoing_events_start_time:
        key_chain = ['triggers','particle_intensity','ongoing_events',
                    'start_time']
    if value == id_pi_ongoing_events_threshold:
        key_chain = ['triggers','particle_intensity','ongoing_events',
                    'threshold']
    if value == id_pi_ongoing_events_energy_min:
        key_chain = ['triggers','particle_intensity','ongoing_events',
                    'energy_min']
    if value == id_pi_ongoing_events_energy_max:
        key_chain = ['triggers','particle_intensity','ongoing_events',
                    'energy_max']
