...
def report(output_dir, relative_path_plots): ### ADD OPTIONAL ARGUMENT HERE
    ...
    for i in range(0, len(models)):
        ...
        for j in range(0, len(appendages)):
            ...
            info_text = 'Date of Report: ' + datetime.datetime.today().strftime('%Y-%m-%d' + 'T' + '%H:%M:%S' + ' US Central Time') + '<br>'
            info_text += 'Report generated by SPHINX<br>'
            info_text += 'This code may be publicly accessed at: ' + '[https://github.com/ktindiana/sphinxval](https://github.com/ktindiana/sphinxval)<br>'
